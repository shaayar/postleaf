...
export default function Profile() {
  const { loading, error, profile, userEmail, refresh } =
    useUser();
  ...
  const openEditor = useCallback(
    (field: "username" | "bio") => {
      setEditField(field);
      setFormValue(
        field === "username" ? profile?.username ?? "" : profile?.bio ?? ""
      );
      setSaveError(null);
            ...
            <Column fillWidth>
              ...
              <Column fillWidth padding="4">
                ...
                >
                  ...
                  {/* Role section intentionally removed */}
                    ...
                    >
                      ...
                      <Row minWidth="56">
                        <Button
                          fillWidth
                          size="s"
                          label={profile.username ? "Edit" : "Add"}
                          variant="secondary"
            ...
            >
              {validation.bio.maxLength - formValue.length < 100 && (
                <Row
                  ...
                  textVariant="label-default-s"
                  onBackground={
                    validation.bio.maxLength - formValue.length < 10
                      ? "danger-weak"
                      : validation.bio.maxLength - formValue.length < 25
                        ? "warning-weak"
                        : "neutral-weak"
                  }
                  paddingRight="4"
